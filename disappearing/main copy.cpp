...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // // std::cout << "random: " << rand() % amount << std::endl;
        // unsigned int delete_idx = rand() % amount;
        // cube_positions.erase(cube_positions.begin()+delete_idx);
        // std::cout << "delete_idx: " << delete_idx << std::endl;
        // amount = cube_positions.size();
